        ...
        try {
            ...
            if($cart)
            {
                ...
                foreach ($products as $key => $product)
                {
                    ...
                    //delete item
                    $prductRemove =  ShopCart::where('account', Auth::user()->UserNum)
                                        ->where('ProductID', $product['ProductID'])->first();
                    $prductRemove->delete();
                }
                ...
                return response()->json([
                    'error' => true,
                    'message' => "Você não tem produtos no carrinho!",
                ]);
            }
        } catch (\Throwable $th) {
            return response()->json([
                'error' => true,
                'message' => "Falha ao tentar comprar o produto, tente novamante!",
            ]);
        }
